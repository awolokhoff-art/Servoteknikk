...
void loop() {
  ...
  switch (physicalState) {
    ...
    case P_MOVING: {
      ...
      PwmValue = constrain(abs(output), 0, 220); // Constrain PWM 0-100
  ...
  // This will now handle the "OPEN" and "IDLE"/"MOVING" states.
  // The "HALF" states are handled by the forced update above.
